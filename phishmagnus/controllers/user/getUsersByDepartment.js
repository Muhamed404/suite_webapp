...
async function getUsersByDepartment(req, res) {
  try {
    logger.info("Incoming request for getUsersByDepartment with params: " + JSON.stringify(redactLogData(req.params), null, 2));
    ...
    logger.info('Printing assigned users for department ' + deptId + ' and organization ' + organization + ': ' + JSON.stringify(redactLogData(users), null, 2));
