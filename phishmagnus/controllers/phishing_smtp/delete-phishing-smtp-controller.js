...
exports.deletePhishingSMTP = (req, res) => {
  ...
  apiClient
    ...
    .then((response) => {
      ...
      logger.info(`Delete Phishing SMTP Controller: Response ${JSON.stringify(data, null, 2)}`);
    ...
    .catch((error) => {
      ...
      logger.error(`Delete Phishing SMTP Controller: Backend error response: ${JSON.stringify(errData, null, 2)}`);
