...
exports.listOfPhishingSMTPNameController = (req, res) => {
  ...
  apiClient
    ...
    .then((response) => {
      ...
      logger.info(`Listing Of Phishing SMTP Name Controller: Response ${JSON.stringify(redactLogData(data), null, 2)}`);
    ...
    .catch((error) => {
      ...
      logger.error(`Listing Of Phishing SMTP Name Controller: Error details ${JSON.stringify(redactLogData(error.response?.data), null, 2)}`);
