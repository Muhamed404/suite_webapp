 ...
 */
exports.renderSMSCampaignReport = async (req, res) => {
    try {
        ...
        const templateData = {
            ...
            emptyMessage: req.__('sms.campaign_report.empty_message')
        };
...
exports.getCampaignDetails = async (req, res) => {
    try {
        ...
        const apiClient = getApiClient(req);
        const response = await apiClient.get(`${backend_api_urls.PHISHMAGNUS.CAMPAIGN.SMS.VIEW}/${campaignId}`);
