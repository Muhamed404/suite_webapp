    ...
    try {
        ...
        if (req.method === "GET") {
            ...
            const campaignFilters = {
                ...
                phishing_campaign_type_id: enums.phishingType.QR
            };
            ...
            const campaigns = rawCampaigns.map(item => {
                ...
                return {
                    ...
                    totalQRImages: item.totalQRCount,
            ...
            return res.render(render_ejs_urls.PhishMagnus.Campaign.QR.CAMPAIGN_REPORT, templateData);
        }
...
// Separate endpoint for AJAX data
