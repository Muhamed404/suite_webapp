...
export default function CampaignLeaderboardPage() {
  ...
  const getAvatarImage = (avatarLevel: number) => {
    ...
    return `/jnr/images/avatars/${imageNumber}.png`;
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
            <div className="bg-white rounded-2xl p-3 flex justify-between">
              ...
              <div className="w-7 h-7 bg-red-100 rounded-full flex items-center justify-center">
                <img alt="" src="/jnr/images/assing/assingment.svg" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3 flex justify-between">
              ...
              <div className="w-7 h-7 bg-gray-200 rounded-full flex items-center justify-center">
                <img alt="" src="/jnr/images/assing/pending.svg" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-3 flex justify-between">
              ...
              <div className="w-7 h-7 bg-red-100 rounded-full flex items-center justify-center">
                <img alt="" src="/jnr/images/assing/res-rate.svg" />
              </div>
            </div>
          </div>
