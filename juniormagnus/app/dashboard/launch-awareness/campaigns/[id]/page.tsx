          ...
          <div className="grid grid-cols-12 gap-2 mb-2">
              ...
              <div className="bg-gray-50 p-4 rounded-xl space-y-4">
                <div className="flex items-center gap-1.5">
                  <span className="w-4 h-4">
                    <img alt="" className="w-full h-full" src="/jnr/images/img/calendar.svg" />
                  </span>
              ...
              <div className="bg-white rounded-xl p-4 h-full">
                <div className="flex justify-between items-start">
                  ...
                  <div className="w-6 h-6">
                    <img alt="" className="w-full h-full" src="/jnr/images/profile.svg" />
                  </div>
                </div>
            ...
            <div className="col-span-4 row-span-4 col-start-9 row-start-3 bg-white rounded-lg p-3 flex flex-col">
                ...
                campaignDashboard.top_struggling_topics.length > 0 ? (
                  campaignDashboard.top_struggling_topics
                    ...
                    .map((topic: any, idx: number) => {
                      ...
                      > = {
                        "WIFI Security": {
                          icon: "/jnr/images/icons/wifi.svg",
                          color: "#C9F1E2",
                          textColor: "#0D9488",
                        },
                        "Physical Security": {
                          icon: "/jnr/images/icons/physical.svg",
                          color: "#DCE9FF",
                          textColor: "#2563EB",
                        },
                        "Phishing Security": {
                          icon: "/jnr/images/icons/phishing.svg",
                          color: "#FEE2E2",
                          textColor: "#DC2626",
                        },
                      };
                      const config = iconMap[topicDisplayName] || {
                        icon: "/jnr/images/icons/default.svg",
                        color: "#F0F0F0",
                        textColor: "#666",
                      };
              ...
              <p className="text-[8px] text-red-600 mt-2 flex items-center gap-1">
                <img alt="" className="w-2.5 h-2.5" src="/jnr/images/icons/alert.svg" />
            ...
            <div className="col-span-4 row-span-5 col-start-9 row-start-7 bg-white rounded-xl p-3 space-y-4">
              ...
              <div className="bg-[#FFEEE7] p-2 rounded-xl flex items-center justify-between border border-orange-200">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5">
                    <img alt="" className="w-full h-full" src="/jnr/images/fire-red.svg" />
                  </div>
              ...
              <div className="bg-[#E6FFFA] p-2 rounded-xl flex items-center justify-between border border-teal-300">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5">
                    <img alt="" className="w-full h-full" src="/jnr/images/fire-teal.svg" />
                  </div>
                  <span className="text-gray-700 font-medium text-[10px]">
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className="col-span-3 row-span-1 bg-white rounded-xl p-3 flex flex-col justify-between">
                <div className="flex items-center gap-1.5 text-xs text-gray-500 font-medium">
                  <span className="text-lg">
                    <img alt="" className="w-5 h-5" src="/jnr/images/gard_cap.svg" />
                  </span>
                  <div>
              ...
              <div className="col-span-3 row-span-1 col-start-4 bg-white rounded-xl p-3 flex flex-col justify-start">
                <div className="flex items-center gap-1.5 text-xs text-gray-500 font-medium">
                  <span className="text-lg">
                    <img alt="" className="w-5 h-5" src="/jnr/images/clock_icon.svg" />
                  </span>
                  <div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <h2 className="font-semibold text-gray-900 text-base flex items-center gap-1.5">
                      <span className="text-lg">
                        <img alt="" className="w-5 h-5" src="/jnr/images/img/Icon_Trophy.svg" />
                      </span>
                      ...
                      <Tooltip key={achievementId} content={tooltipContent} placement="top">
                        ...
                        >
                          <img
                            ...
                            src={`/jnr/images/achivement/${imageFileName}`}
                          />
                        </div>
                      </Tooltip>
                    );
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          src={`/jnr/images/avatars/${resolveAvatarImage(mainAvatar)}`}
                        />
                      </div>
                    </Tooltip>
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            >
                              <img
                                ...
                                src={`/jnr/images/avatars/${avatarImage}`}
                              />
                            </div>
                            <p
