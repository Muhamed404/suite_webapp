...
const CAMPAIGN_DRAFT_STORAGE_KEY = "juniormagnus:create-campaign:draft";
const CAMPAIGN_DRAFT_PRESERVE_ONCE_KEY = "juniormagnus:create-campaign:draft:preserve-once";
