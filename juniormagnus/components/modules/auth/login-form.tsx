  ...
  return (
    <form className="flex flex-col items-stretch w-full" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mt-6 md:mt-10">
        <div>
          <Input
            ...
            classNames={{
              base: "w-full",
              inputWrapper:
                "px-5 py-3.5 rounded-full bg-[var(--gray)] border border-[var(--strokeGray)] focus-within:border-[var(--primary-color)] transition-colors duration-300",
        ...
        <Button
          className="w-full mt-8 px-6 py-3 rounded-full bg-[var(--primary-color)] text-white border border-transparent transition-all duration-300 hover:bg-transparent hover:border-[var(--primary-color)] hover:text-[var(--primary-color)]"
