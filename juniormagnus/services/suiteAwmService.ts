...
export const suiteAwmService = {
  ...
  /** GET /api/jnr/campaign/:id (AWM Backend) - Get campaign by ID */
  getCampaignById: (id: number) => awmGet<any>(`${API_BASE}/campaign/${id}`),

  /** POST /api/jnr/campaign (AWM Backend) - Create campaign */
  createCampaign: (payload: any) => awmPost<any>(`${API_BASE}/campaign`, payload),

  /** PUT /api/jnr/campaign/:id (AWM Backend) - Update campaign */
  updateCampaign: (id: number, payload: any) => awmPut<any>(`${API_BASE}/campaign/${id}`, payload),

  /** DELETE /api/jnr/campaign/:id (AWM Backend) - Delete campaign */
  deleteCampaign: (id: number) => awmDel<any>(`${API_BASE}/campaign/${id}`),

  /** GET /api/jnr/campaign/:id/retry-user-fetch (AWM Backend) - Retry user fetch */
  ...
  /** GET /api/jnr/dashboard/organizations/campaign/users (AWM Backend) - Get campaign leaderboard with user statistics */
  ...
  /** GET /api/jnr/dashboard/organizations/campaign (AWM Backend) - Get campaign dashboard with all details and metrics */
  getCampaignDashboard: (campaignId: number) =>
    awmGet<any>(`${API_BASE}/dashboard/organizations/campaign?campaign_id=${campaignId}`),

  /** POST /api/jnr/report-actions/submit-quiz (AWM Backend) - Submit quiz answers */
  submitQuiz: (payload: {
    campaign_id: number;
    module_id: number;
    content_id: number;
