...
type SortField = "survey_name" | "total_submitted" | "issue_date" | "deadline_date" | "progress_percentage";
                            ...
                            {isLoading ? (
                                ...
                                <div className="flex items-center justify-center py-20">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-lg font-semibold text-gray-700 mb-2">Error Loading Surveys</h3>
                                ...
                                <div className="flex items-center justify-center py-20">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-gray-500">Try adjusting your search or create a new survey</p>
                                    </div>
                                </div>
                            ) : (
                                <>
                                            ...
                                            <tbody className="divide-y divide-gray-100">
                                                {paginatedSurveys.map((survey) => (
                                                    ...
                                                    >
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                <div className="w-24 bg-gray-200 rounded-full h-2">
                                                                    <div
                                                                        ...
                                                                        style={{ width: `${Math.min(survey.progress_percentage ?? 0, 100)}%` }}
                                                                    />
                                                                </div>
                                                                <span className="text-xs font-medium text-gray-700">
                                                        ...
                                                        <td className="px-6 py-3.5">
                                                            {getStatusBadge(survey.status?.name)}
                                                        </td>
                                                        <td className="px-6 py-3.5">
                                                            <Button
                                                                as={Link}
