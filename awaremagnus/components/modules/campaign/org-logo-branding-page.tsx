...
export default function OrgLogoBrandingPage() {
  ...
  const defaultLogoIcon = getContentAssetUrl("/images/img/aware-icon.svg");
  const defaultLogoName = getContentAssetUrl("/images/img/aware-name.svg");
                ...
                <div className="bg-[#0B1A2E] rounded-2xl p-8 flex flex-col items-center justify-center min-h-[200px] gap-4">
                  {displayLogoUrl ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Image alt="Aware Magnus" className="h-5 w-auto" height={20} src={defaultLogoName} width={100} />
                    </div>
                  )}
