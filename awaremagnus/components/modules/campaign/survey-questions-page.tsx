                            ...
                            <div className="flex flex-row gap-3">
                                ...
                                <Select
                                    ...
                                    onSelectionChange={(keys) => {
                                        ...
                                        if (v) { setCategoryFilter(v); setCurrentPage(1); }
                                    }}
                                    classNames={{
                                        base: "w-36",
                                    ...
                                    items={[{ id: "all", name: "All Categories" }, ...(categories as any[]).map((cat: any) => ({ id: String(cat.id), name: cat.name }))]}
                                >
                                    {(item: any) => (
                                ...
                                <Select
                                    ...
                                    onSelectionChange={(keys) => {
                                        const v = Array.from(keys as Set<string>)[0];
                                        if (v) { setTypeFilter(v); setCurrentPage(1); }
                                    }}
                                    classNames={{
                                        base: "w-36",
                                        trigger: "h-9 bg-white border border-gray-200 rounded-full",
