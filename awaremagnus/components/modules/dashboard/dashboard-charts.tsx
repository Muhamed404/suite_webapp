  ...
  return (
    <div className="grid grid-cols-12 gap-2">
      ...
      <div className="col-span-4 row-span-3 row-start-9 bg-white rounded-xl p-4 flex flex-col items-center justify-between">
        ...
        <div className="semichart w-72 h-72" data-sent="120" data-opened="90" data-admin="30" />
      </div>
      ...
      <div className="col-span-4 col-start-5 row-start-9 bg-white rounded-xl p-4 flex flex-col items-center justify-between">
        ...
        <div
          ...
          style={{ "--color": "#3ACE89", "--color2": "#FB5050" } as React.CSSProperties}
          data-text-size="28px"
          data-value="50"
        />
        ...
        <div className="flex justify-center gap-3 text-[10px] text-gray-600">
          <span className="flex items-center gap-1">
            <span className="w-1.5 h-1.5 bg-green-400 rounded-full"></span>Certified: 16
          </span>
          <span className="flex items-center gap-1">
            <span className="w-1.5 h-1.5 bg-red-400 rounded-full"></span>Not Certified: 18
          </span>
        </div>
      </div>
          ...
          <CardBody className="p-4 flex flex-col h-full justify-center">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                <Image src="/images/icons/shield.svg" alt="" width={40} height={40} className="w-10 h-10" />
                <div>
        ...
        <Card>
          <CardBody className="p-4 flex flex-col">
            ...
            <div className="space-y-1.5">
              {[
                { icon: "/images/icons/wifi.svg", label: "WIFI Security", color: "bg-[#C9F1E2]", iconColor: "text-[#0D9488]" },
                { icon: "/images/icons/physical.svg", label: "Physical Security", color: "bg-[#DCE9FF]", iconColor: "text-[#2563EB]" },
                { icon: "/images/icons/phishing.svg", label: "Phishing Security", color: "bg-[#FEE2E2]", iconColor: "text-[#DC2626]" },
              ].map((topic, index) => (
                <div
                  key={index}
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className={`w-6 h-6 rounded-full ${topic.color} flex items-center justify-center ${topic.iconColor}`}>
                      <Image src={topic.icon} alt="" width={12} height={12} className="w-3 h-3" />
                    </div>
        ...
        <Card className="bg-[#10B981] text-white">
          <CardBody className="p-4 flex justify-between items-center h-full">
            ...
            <div className="w-12 h-12">
              <Image src="/images/check-fr.svg" alt="" width={48} height={48} className="w-12 h-12" />
            </div>
          </CardBody>
        </Card>
      </div>
