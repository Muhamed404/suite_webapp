...
export const SUITE_PRIMARY_MENU_ITEMS: SuitePrimaryMenuItem[] = [
  { label: "Suite Management", link: "/home", imgPath: "/images/icons/primary-suit.svg" },
  { label: "Package", link: "/package/list", imgPath: "/images/icons/primary_group.svg" },
  { label: "Services", link: "/app_service/list", imgPath: "/images/icons/Settings.svg" },
  {
    label: "Organization",
    link: "/organization/",
    imgPath: "/images/icons/primary-organization.svg",
  },
  { label: "User", link: "/user/securemagnus-users", imgPath: "/images/icons/primary-uses.svg" },
  {
    label: "Categories",
    link: "/cybersecurity/categories/list",
    imgPath: "/images/icons/cyber-security.svg",
  },
  {
    label: "Settings",
