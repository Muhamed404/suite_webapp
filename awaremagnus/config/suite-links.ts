...
export const SUITE_PRIMARY_MENU_ITEMS: SuitePrimaryMenuItem[] = [
  { label: "Suite Management", link: "/home", imgPath: getContentAssetUrl("/images/icons/primary-suit.svg") },
  { label: "Package", link: "/package/list", imgPath: getContentAssetUrl("/images/icons/primary_group.svg") },
  { label: "Services", link: "/app_service/list", imgPath: getContentAssetUrl("/images/icons/Settings.svg") },
  {
    label: "Organization",
    link: "/organization/",
    imgPath: getContentAssetUrl("/images/icons/primary-organization.svg"),
  },
  { label: "User", link: "/user/securemagnus-users", imgPath: getContentAssetUrl("/images/icons/primary-uses.svg") },
  {
    label: "Categories",
