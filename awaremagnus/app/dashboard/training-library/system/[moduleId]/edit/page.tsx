...
export default function SystemLibraryEditModulePage() {
  ...
  const backHref = `/dashboard/training-library/system/${moduleId}`;
          ...
          <div className="bg-[#F3F7FA] min-h-screen">
            ...
            >
              ...
              <Link
                ...
                href="/dashboard/training-library/system"
              >
                {tDashboard("menu.systemLibrary") ?? "Core Modules"}
              </Link>
              <span className="text-gray-400">›</span>
              <Link
                className="hover:text-gray-700 transition"
