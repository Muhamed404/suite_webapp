...
export const DASHBOARD_KEYS = {
    system: {
        ...
        leaderboard: (count?: number, sortBy?: string) => ["dashboard", "system", "leaderboard", { count, sortBy }],
    },
    organization: {
        list: (params?: { orgId?: number; limit?: number; offset?: number }) => ["dashboard", "organization", "list", params],
        monthlyCompletion: (campaignId?: number) => ["dashboard", "organization", "monthlyCompletion", { campaignId }],
        strugglingModules: (orgId?: number) => ["dashboard", "organization", "strugglingModules", { orgId }],
        leaderboard: (params?: { count?: number; campaignId?: number; sortBy?: string }) => ["dashboard", "organization", "leaderboard", params],
    },
    user: {
        list: (params?: { orgId?: number; userId?: number; limit?: number; offset?: number }) => ["dashboard", "user", "list", params],
    },
    gamification: {
        achievementStats: (orgId?: number) => ["gamification", "achievements", "statistics", { orgId }],
        achievements: (params?: { limit?: number; offset?: number; sortBy?: string; sortOrder?: string }) => ["gamification", "achievements", "list", params],
        ...
        scoreLevelsByType: (scoreTypeId: number) => ["gamification", "scoreLevels", "byType", scoreTypeId],
    },
};
...
export const useOrganizationDashboards = (params?: { orgId?: number; limit?: number; offset?: number }) => {
    return useQuery({
...
export const useOrganizationLeaderboard = (params?: { count?: number; campaignId?: number; sortBy?: string }) => {
    return useQuery({
...
export const useUserDashboards = (params?: { orgId?: number; userId?: number; limit?: number; offset?: number }) => {
    return useQuery({
...
export const useAchievements = (params?: { limit?: number; offset?: number; sortBy?: string; sortOrder?: string }) => {
    return useQuery({
