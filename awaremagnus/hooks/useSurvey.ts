...
export const SURVEY_KEYS = {
    ...
    users: (id: number, params?: Record<string, any>) =>
        ["surveys", id, "users", params] as const,
    ...
    questions: (params?: Record<string, any>) =>
        ["survey-questions", params] as const,
...
export function useCreateSurvey() {
    ...
    return useMutation({
        mutationFn: (payload: SurveyCreatePayload) =>
...
export function useSurveyUserAnswers(
    ...
    return useQuery({
        ...
        queryFn: () =>
            surveyService.getSurveyUserAnswers(surveyId, userId, params),
...
export function useUpdateSurveyQuestion() {
    ...
    return useMutation({
        mutationFn: ({
            ...
            id: number;
            payload: SurveyQuestionUpdatePayload;
