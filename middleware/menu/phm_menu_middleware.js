...
function generatePhishMagnusMenu(req, organization) {
  ...
  const productMenu = [
    ...
    },
    {
      ...
      img_path: "/securemagnus_2025/images/champaign.svg",
    ...
    },
    {
      ...
      img_path: "/securemagnus_2025/images/users-profile-group.svg",
      allowedRoles: [enums.userType.OrgSuperAdmin, enums.userType.OrgSubAdmin],
    },
    {
      module: "My Templates",
      ...
      img_path: "/securemagnus_2025/images/templateManagement.svg",
      allowedRoles: [enums.userType.OrgSuperAdmin, enums.userType.OrgSubAdmin],
    },
    {
      ...
      link: "/template/list",
      img_path: "/securemagnus_2025/images/system_template/system_template_template_catagorie.svg",
      allowedRoles: [enums.userType.MagSuperAdmin, enums.userType.MagSubAdmin, enums.userType.OrgSuperAdmin, enums.userType.OrgSubAdmin],
    },
    {
      module: "Reports",
      ...
      img_path: "/securemagnus_2025/images/Icons_Campaign_Report/Report_Admin.svg",
      allowedRoles: [enums.userType.OrgSuperAdmin, enums.userType.OrgSubAdmin],
    },
  ];
